...
<form>
  <button class="pull-right" formaction="com_rpt_basic.php?id=<?php echo $_GET["id"]; ?>" ><i class="fa fa-download"></i></button>
</form>
<br>
<?php
//    echo"<button style='margin-left:500px;'>".$_GET["id"]."</button>";
    echo"<br><br>";
